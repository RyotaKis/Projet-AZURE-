  ...
  return (
    <header className="fixed top-0 left-16 right-0 h-14 bg-white border-b border-slate-200 flex items-center justify-between px-6 z-40">
      <div className="flex items-center gap-4">
        <h1 className="font-bold text-lg tracking-tight">AZURE<span className="text-[#0052FF] font-black">+</span> <span className="text-[10px] font-normal text-slate-400 ml-2 uppercase tracking-widest leading-none">Security Control</span></h1>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 border-l border-slate-200 pl-4">
            ...
            <span className="text-[10px] font-bold uppercase tracking-tight hidden lg:block">A. Hamilton</span>
          </div>
        </div>
      </div>
    </header>
