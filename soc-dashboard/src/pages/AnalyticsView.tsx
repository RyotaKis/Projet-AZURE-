...
import { BarChart3, TrendingUp, ShieldCheck, AlertTriangle, Download } from 'lucide-react';
    ...
    <div className="flex-1 overflow-y-auto p-6 bg-[var(--color-bg-main)]">
      <div className="mb-6">
        ...
        <div className="flex gap-4">
          <button 
            onClick={() => toast.success('Génération du rapport PDF en cours...')}
            className="flex items-center gap-2 bg-[#0052FF] text-white px-4 py-2 rounded-lg font-bold text-sm hover:bg-blue-700 transition-colors"
          >
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-[var(--color-surface)] p-4 rounded-xl border border-[var(--color-border-subtle)]">
          ...
          <div className="text-2xl font-mono font-bold text-slate-900">99.94%</div>
        ...
        <div className="bg-[var(--color-surface)] p-4 rounded-xl border border-[var(--color-border-subtle)]">
          ...
          <div className="text-2xl font-mono font-bold text-slate-900">0.06%</div>
        ...
        <div className="bg-[var(--color-surface)] p-4 rounded-xl border border-[var(--color-border-subtle)]">
          ...
          <div className="text-2xl font-mono font-bold text-slate-900">124ms</div>
        ...
        <div className="bg-[var(--color-surface)] p-4 rounded-xl border border-[var(--color-border-subtle)]">
          ...
          <div className="text-2xl font-mono font-bold text-slate-900">$4.2M</div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-[var(--color-surface)] p-6 rounded-xl border border-[var(--color-border-subtle)] h-[300px] flex flex-col items-center justify-center text-center">
           ...
           <button 
             onClick={() => toast.success('Rapport SHAP généré avec succès.')}
             className="bg-[#0052FF] text-white px-6 py-2 rounded uppercase font-bold text-[10px] tracking-widest hover:bg-blue-700 transition-colors"
           >
